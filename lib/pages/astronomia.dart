...
class Astronomia extends StatefulWidget {
  const Astronomia({Key? key}) : super(key: key);

  @override
  _AstronomiaState createState() => _AstronomiaState();
}

class _AstronomiaState extends State<Astronomia> {
